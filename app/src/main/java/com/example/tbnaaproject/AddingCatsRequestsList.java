...
public class AddingCatsRequestsList extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adding_cats_requests_list);
        ...
        ListView listView = (ListView) findViewById(R.id.activity_adoption_requests_adminList2);
